...
// const dom = new JSDOM(input:'',options:{url:"http://q.10jqka.com.cn/"});
const dom = new JSDOM("",{ url:"http://q.10jqka.com.cn/",
...
// 同花顺 ctrl + A + C 的源码
var TOKEN_SERVER_TIME = 1726398879.236;
!function(n, t) {
    !function() {
        var r, e, a;
        r = e = a = n;
